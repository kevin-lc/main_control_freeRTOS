...
HD_PWD='E:/firmware/XILINX/demo/main_control_RTOS/main_control_RTOS.runs/main_control_VGCLK_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_control_VGCLK_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_control_VGCLK_0.tcl
