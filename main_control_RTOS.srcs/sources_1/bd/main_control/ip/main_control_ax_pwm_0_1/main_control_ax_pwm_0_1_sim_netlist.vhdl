...
-- Date        : Tue Jun 16 16:22:48 2020
-- Host        : RD-DELL running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/firmware/XILINX/demo/main_control_RTOS/main_control_RTOS.srcs/sources_1/bd/main_control/ip/main_control_ax_pwm_0_1/main_control_ax_pwm_0_1_sim_netlist.vhdl
-- Design      : main_control_ax_pwm_0_1
...
entity main_control_ax_pwm_0_1_ax_pwm is
  port (
    ltrig : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of main_control_ax_pwm_0_1_ax_pwm : entity is "ax_pwm";
end main_control_ax_pwm_0_1_ax_pwm;

architecture STRUCTURE of main_control_ax_pwm_0_1_ax_pwm is
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \delay_cnt[0]_i_2_n_0\ : STD_LOGIC;
  signal delay_cnt_reg : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \delay_cnt_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_1\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_2\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_3\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_4\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_5\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_6\ : STD_LOGIC;
  signal \delay_cnt_reg[0]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \^lasel\ : STD_LOGIC;
  signal lasel_out_r_i_1_n_0 : STD_LOGIC;
  signal lasel_out_r_i_2_n_0 : STD_LOGIC;
  signal lasel_out_r_i_3_n_0 : STD_LOGIC;
  signal lasel_out_r_i_4_n_0 : STD_LOGIC;
  signal lasel_out_r_i_5_n_0 : STD_LOGIC;
  signal lasel_out_r_i_6_n_0 : STD_LOGIC;
  signal lasel_out_r_i_7_n_0 : STD_LOGIC;
  signal lasel_out_r_i_8_n_0 : STD_LOGIC;
  signal \^ltrig\ : STD_LOGIC;
  signal \NLW_delay_cnt_reg[28]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
begin
  SR(0) <= \^sr\(0);
  lasel <= \^lasel\;
  ltrig <= \^ltrig\;
\delay_cnt[0]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_cnt_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => lasel_out_r_i_2_n_0,
      D => \delay_cnt_reg[0]_i_1_n_7\,
      Q => delay_cnt_reg(0)
    );
\delay_cnt_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \delay_cnt_reg[0]_i_1_n_0\,
      CO(2) => \delay_cnt_reg[0]_i_1_n_1\,
      CO(1) => \delay_cnt_reg[0]_i_1_n_2\,
      CO(0) => \delay_cnt_reg[0]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
      O(3) => \delay_cnt_reg[0]_i_1_n_4\,
      O(2) => \delay_cnt_reg[0]_i_1_n_5\,
      O(1) => \delay_cnt_reg[0]_i_1_n_6\,
      O(0) => \delay_cnt_reg[0]_i_1_n_7\,
      S(3 downto 1) => delay_cnt_reg(3 downto 1),
      S(0) => \delay_cnt[0]_i_2_n_0\
    );
...
lasel_out_r_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
      I0 => \^lasel\,
      I1 => lasel_out_r_i_3_n_0,
      I2 => lasel_out_r_i_4_n_0,
      O => lasel_out_r_i_1_n_0
    );
lasel_out_r_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^ltrig\,
      O => lasel_out_r_i_2_n_0
    );
lasel_out_r_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => delay_cnt_reg(31),
      I5 => delay_cnt_reg(30),
      O => lasel_out_r_i_3_n_0
    );
lasel_out_r_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000080000000"
    )
        port map (
      I0 => lasel_out_r_i_5_n_0,
      I1 => lasel_out_r_i_6_n_0,
      I2 => lasel_out_r_i_7_n_0,
      I3 => lasel_out_r_i_8_n_0,
      I4 => delay_cnt_reg(1),
      I5 => delay_cnt_reg(0),
      O => lasel_out_r_i_4_n_0
    );
lasel_out_r_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
      ...
      I4 => delay_cnt_reg(25),
      I5 => delay_cnt_reg(24),
      O => lasel_out_r_i_5_n_0
    );
lasel_out_r_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
      ...
      I4 => delay_cnt_reg(19),
      I5 => delay_cnt_reg(18),
      O => lasel_out_r_i_6_n_0
    );
lasel_out_r_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
      ...
      I4 => delay_cnt_reg(13),
      I5 => delay_cnt_reg(12),
      O => lasel_out_r_i_7_n_0
    );
lasel_out_r_i_8: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => delay_cnt_reg(7),
      I5 => delay_cnt_reg(6),
      O => lasel_out_r_i_8_n_0
    );
lasel_out_r_reg: unisim.vcomponents.FDPE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => lasel_out_r_i_1_n_0,
      PRE => lasel_out_r_i_2_n_0,
      Q => \^lasel\
    );
ltrig_out_r_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
ltrig_out_r_reg: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \^sr\(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity main_control_ax_pwm_0_1_ax_pwm_v1_0_S00_AXI is
  port (
    lasel : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of main_control_ax_pwm_0_1_ax_pwm_v1_0_S00_AXI : entity is "ax_pwm_v1_0_S00_AXI";
end main_control_ax_pwm_0_1_ax_pwm_v1_0_S00_AXI;

architecture STRUCTURE of main_control_ax_pwm_0_1_ax_pwm_v1_0_S00_AXI is
  signal \^s_axi_arready\ : STD_LOGIC;
  signal \^s_axi_awready\ : STD_LOGIC;
  signal \^s_axi_wready\ : STD_LOGIC;
  signal aw_en_i_1_n_0 : STD_LOGIC;
  signal aw_en_reg_n_0 : STD_LOGIC;
  signal ax_pwm_m0_n_1 : STD_LOGIC;
...
ax_pwm_m0: entity work.main_control_ax_pwm_0_1_ax_pwm
     port map (
      Q(0) => slv_reg2(0),
      SR(0) => ax_pwm_m0_n_1,
      lasel => lasel,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity main_control_ax_pwm_0_1_ax_pwm_v1_0 is
  port (
    lasel : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of main_control_ax_pwm_0_1_ax_pwm_v1_0 : entity is "ax_pwm_v1_0";
end main_control_ax_pwm_0_1_ax_pwm_v1_0;

architecture STRUCTURE of main_control_ax_pwm_0_1_ax_pwm_v1_0 is
begin
ax_pwm_v1_0_S00_AXI_inst: entity work.main_control_ax_pwm_0_1_ax_pwm_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity main_control_ax_pwm_0_1 is
  port (
    ltrig : out STD_LOGIC;
    lasel : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of main_control_ax_pwm_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of main_control_ax_pwm_0_1 : entity is "main_control_ax_pwm_0_1,ax_pwm_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of main_control_ax_pwm_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of main_control_ax_pwm_0_1 : entity is "ax_pwm_v1_0,Vivado 2018.3";
end main_control_ax_pwm_0_1;

architecture STRUCTURE of main_control_ax_pwm_0_1 is
...
inst: entity work.main_control_ax_pwm_0_1_ax_pwm_v1_0
     port map (
